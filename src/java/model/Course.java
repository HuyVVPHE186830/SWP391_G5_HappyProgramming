...
public class Course {
    ...
    public Course(int courseId, String courseName, String courseDescription, Date createdAt, int countMentee, int countMentor, String mentorName, List<Category> categories) {
