                    ...
                    <form action="userProfile" method="post" id="userProfileForm">
                        ...
                        <div class="input-container">
                            ...
                            <div class="name-input">
                                <input type="text" name="firstName" value="<%= user.getFirstName() %>" pattern="^[^\s][\p{L}\s]*[^\s]$" title="First Name cannot have leading or trailing spaces and must contain at least one non-space character">
                                <label>Last Name:</label>
                                <input type="text" name="lastName" value="<%= user.getLastName() %>" pattern="^[^\s][\p{L}\s]*[^\s]$" title="Last Name cannot have leading or trailing spaces and must contain at least one non-space character">
                            </div>
                        </div>
                        <div class="input-container">
